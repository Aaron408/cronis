...
const Dashboard = () => {
  ...
  const barChartData = [5000, 7000, 6000, 8000, 9000, 11000, 12000, 14000, 15000, 16000, 17000, 18000];
  ...
  const lineChartData = [{ name: "Usuarios", data: [30, 40, 35, 50, 49, 60, 70, 91, 125, 145, 160, 175] }];
        ...
        <div className="p-6">
            ...
            {[
              ...
              <div key={index} className="p-4 bg-white rounded-lg shadow">
                ...
                <div className="flex items-baseline mt-4">
                  ...
                  <p className={`ml-2 text-sm font-medium ${card.change.startsWith("+") ? "text-green-600" : "text-red-600"}`}>
                    {card.change}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-2">
            <div className="p-4 bg-white rounded-lg shadow">
              <h3 className="text-base font-medium text-gray-900 mb-4">Crecimiento en usuarios</h3>
              <Chart options={lineChartOptions} series={lineChartData} type="line" height={250} />
            </div>
            <div className="p-4 bg-white rounded-lg shadow">
              <h3 className="text-base font-medium text-gray-900 mb-4">Gráfica de ganancias mensuales</h3>
              <Chart options={barChartOptions} series={[{ name: "Ganancias", data: barChartData }]} type="bar" height={250} />
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <ul>
              {[
                ...
                { user: "Bob Johnson", action: "uploaded a file", time: "1 day ago" },
                { user: "Alice Brown", action: "commented on a project", time: "2 days ago" },
              ].map((activity, index) => (
